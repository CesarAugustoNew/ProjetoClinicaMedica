...
public class Agenda {
    ...
    public void apresentarListaDePacientes() {
        System.out.println("Data do Atendimento" + " " + data + ", " + "Médico(a): " + medico.getNome() + ", " + "Especialidade: " + medico.getEspecialidade());

        for (int i = 0; i < pacientes.size(); i++) {
            System.out.println(i+1 + ", " +pacientes.get(i).getNome() + ", " + pacientes.get(i).getTelefone());
        }
    }
